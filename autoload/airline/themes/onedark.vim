function! airline#themes#onedark#refresh()
  ...
  let g:airline#themes#onedark#palette.normal = airline#themes#generate_color_map(s:N1, s:N3, s:N3, s:N3, s:N3, s:N3)
  let g:airline#themes#onedark#palette.normal_modified = airline#themes#generate_color_map(s:NM1, s:N3, s:N3, s:N3, s:N3, s:NM3)

  let g:airline#themes#onedark#palette.insert = airline#themes#generate_color_map(s:I1, s:N3, s:N3, s:N3, s:N3, s:I3)
  let g:airline#themes#onedark#palette.insert_modified = {}

  let g:airline#themes#onedark#palette.replace = airline#themes#generate_color_map(s:R1, s:N3, s:N3, s:N3, s:N3, s:R3)
  let g:airline#themes#onedark#palette.replace_modified = {}

  let g:airline#themes#onedark#palette.visual = airline#themes#generate_color_map(s:V1, s:N3, s:N3, s:N3, s:N3, s:V3)
  let g:airline#themes#onedark#palette.visual_modified = {}

  let g:airline#themes#onedark#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IAc, s:IA, s:IA, s:IA)
  let g:airline#themes#onedark#palette.inactive_modified = airline#themes#generate_color_map(s:IA, s:IA, s:NM3, s:IA, s:IA, s:IA)

  " Warnings
  let s:WI = [s:colors.black.gui, s:colors.dark_yellow.gui, s:colors.white.cterm, s:colors.dark_yellow.cterm]
  let g:airline#themes#onedark#palette.normal.airline_warning = s:WI
  ...
  let g:airline#themes#onedark#palette.normal.airline_error = s:ER
