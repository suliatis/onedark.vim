function! airline#themes#transparentonedark#refresh()
  ...
  let s:NM1 = [s:colors.black.gui, s:colors.dark_yellow.gui, s:colors.black.cterm, s:colors.yellow.cterm]
  let s:NM3 = [s:colors.dark_yellow.gui, s:colors.visual_black.gui, s:colors.yellow.cterm, s:colors.black.cterm]

  " Insert mode
  let s:I1 = [s:colors.black.gui, s:colors.dark_yellow.gui, s:colors.white.cterm, s:colors.yellow.cterm]
  let s:I3 = [s:colors.dark_yellow.gui  , s:colors.visual_black.gui, s:colors.yellow.cterm, s:colors.visual_black.cterm]
  ...
  " Warnings
  let s:WI = [s:colors.black.gui, s:colors.dark_yellow.gui, s:colors.white.cterm, s:colors.yellow.cterm]
